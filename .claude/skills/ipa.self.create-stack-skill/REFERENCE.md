# Stack Skill Reference

Structural contracts, templates, and conventions for IPA stack skills. Load this file at the start of stack skill authoring — all sections are needed throughout the workflow.
