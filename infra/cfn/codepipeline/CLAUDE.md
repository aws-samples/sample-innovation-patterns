...
| CodeBuildProject | `AWS::CodeBuild::Project` | Build project with 7 environment variables, privileged mode |
| Pipeline | `AWS::CodePipeline::Pipeline` | Source (CodeCommit) → Build (CodeBuild) |
...
`APP_NAMESPACE`, `APP_ENV`, `AWS_ACCOUNT_ID`, `ECR_REPO_URI`, `OIDC_ISSUER`, `OIDC_CLIENT_ID`, `OIDC_END_SESSION_ENDPOINT`
