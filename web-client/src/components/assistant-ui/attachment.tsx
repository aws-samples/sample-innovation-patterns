...
import { type PropsWithChildren, useEffect, useSyncExternalStore, useState, type FC } from 'react'
...
/**
 * Creates an object URL for a File and revokes it on change/unmount.
 * Uses useSyncExternalStore to avoid setState-in-effect lint violations.
 */
function createFileUrlStore() {
  ...
  return { subscribe, getSnapshot, set, cleanup }
}

const useFileSrc = (file: File | undefined) => {
  const [store] = useState(createFileUrlStore)
