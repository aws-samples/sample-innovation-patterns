...
export function ModelSelector({ models, types, value, onValueChange }: ModelSelectorProps) {
  const [open, setOpen] = React.useState(false)
  const [peekedModel, setPeekedModel] = React.useState<Model>(value)
    ...
    <div className="grid gap-3">
      <HoverCard openDelay={200}>
        ...
        <HoverCardContent align="start" className="w-[260px] text-sm" side="left">
          The model which will generate the completion. Select from Amazon Bedrock foundation
          models.
        </HoverCardContent>
      </HoverCard>
