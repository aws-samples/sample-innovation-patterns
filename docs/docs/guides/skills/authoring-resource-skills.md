---
title: Authoring Resource Skills
sidebar_position: 4
---

# Authoring Resource Skills
...
1. [IPA Concept Document](../getting-started/concepts/ipa-concept.md) — High-level goals, design philosophy, stacks/patterns/composition model, security model, eject workflow, design tenets
