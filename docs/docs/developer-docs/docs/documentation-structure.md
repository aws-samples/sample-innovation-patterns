...
5. `docs/docs/working/legacy/docs/guide-format/README.md` — Guide authoring meta-guide (research phase)
6. `docs/docs/working/legacy/docs/docs-structure/draft.md` — Design intent for documentation structure and per-section content guidance
