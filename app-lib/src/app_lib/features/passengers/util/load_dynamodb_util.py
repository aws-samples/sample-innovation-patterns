...
if __name__ == "__main__":
    ...
    Usage:
        cd app-lib
        AWS_DEFAULT_REGION=us-east-1 python -m app_lib.features.passengers.util.load_dynamodb_util

    Or with profile:
        AWS_PROFILE=myprofile AWS_DEFAULT_REGION=us-east-1 python -m app_lib.features.passengers.util.load_dynamodb_util
    """
    import sys
